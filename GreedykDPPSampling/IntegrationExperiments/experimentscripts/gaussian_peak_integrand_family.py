"""BQ Experiment with Gaussian peak integrand family."""
import random
import numpy as np
import scipy
...
f, _ = benchmarkfunctions.gaussian_peak_integrand_family(d=d)
...
bayesianquadrature.benchmark_experiment(
    "gaussian_peak_integrand_family", f, result, d, ks, ls, var
)
