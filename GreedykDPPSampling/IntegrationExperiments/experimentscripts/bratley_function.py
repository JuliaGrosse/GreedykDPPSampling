"""BQ Experiment with Bratley function."""
import random
import numpy as np
import scipy
...
f, _ = benchmarkfunctions.bratley_function(d=d)

scipy_f = lambda a, b: f(np.asarray([a, b]))
result = scipy.integrate.dblquad(scipy_f, 0, 1, 0, 1)[0]

bayesianquadrature.benchmark_experiment("bratley_function", f, result, d, ks, ls, var)
