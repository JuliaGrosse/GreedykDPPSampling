"""BQ Experiment with discontinous integrand family."""
import random
import numpy as np
import scipy
...
f, _ = benchmarkfunctions.discontinuous_integrand_family(d=d)
...
bayesianquadrature.benchmark_experiment(
    "discontinuous_integrand_family", f, result, d, ks, ls, var
)
