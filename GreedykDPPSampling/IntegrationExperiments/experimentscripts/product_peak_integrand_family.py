"""BQ Experiment with Product Peak integrand family."""
import random
import numpy as np
import scipy
...
f, _ = benchmarkfunctions.product_peak_integrand_family(d=d)
...
bayesianquadrature.benchmark_experiment(
    "product_peak_integrand_family", f, result, d, ks, ls, var
)
